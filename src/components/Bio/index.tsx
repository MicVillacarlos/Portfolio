...
export const Bio = () =>{
    return(
        ...
        <Container>
            ...
            <br/><br/>
            Aside from coding, I am also passionate about music. I love creating and performing music with my band 🎹. I also enjoy outdoor activities such as cycling, running, weightlifting and hiking. 
            </p>
            <br/>
